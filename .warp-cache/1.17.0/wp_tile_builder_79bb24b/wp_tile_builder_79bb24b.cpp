...
struct wp_args_unpack_group_keys_06cb105b {
    wp::array_t<wp::uint64> packed_pairs;
    wp::array_t<wp::uint32> group_keys;
};


void unpack_group_keys_06cb105b_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_unpack_group_keys_06cb105b *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::uint64> var_packed_pairs = _wp_args->packed_pairs;
    wp::array_t<wp::uint32> var_group_keys = _wp_args->group_keys;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::uint64* var_1;
...
WP_API void unpack_group_keys_06cb105b_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_unpack_group_keys_06cb105b *_wp_args)
{
    ...
    {
        unpack_group_keys_06cb105b_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_copy_pair_count_13cbd63d {
    wp::array_t<wp::int32> pair_prefix;
    wp::int32 item_count;
    wp::array_t<wp::int32> pair_count;
};


void copy_pair_count_13cbd63d_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_copy_pair_count_13cbd63d *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_pair_prefix = _wp_args->pair_prefix;
    wp::int32 var_item_count = _wp_args->item_count;
    wp::array_t<wp::int32> var_pair_count = _wp_args->pair_count;
    //---------
    // primal vars
...
// Python CPU entry points
WP_API void copy_pair_count_13cbd63d_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_copy_pair_count_13cbd63d *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        copy_pair_count_13cbd63d_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_count_sorted_groups_764e2aa8 {
    wp::array_t<wp::uint32> group_keys;
    wp::array_t<wp::int32> group_counts;
};


void count_sorted_groups_764e2aa8_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_count_sorted_groups_764e2aa8 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::uint32> var_group_keys = _wp_args->group_keys;
    wp::array_t<wp::int32> var_group_counts = _wp_args->group_counts;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::uint32* var_1;
...
// Python CPU entry points
WP_API void count_sorted_groups_764e2aa8_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_count_sorted_groups_764e2aa8 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        count_sorted_groups_764e2aa8_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_emit_projected_tile_pairs_79bf94b3 {
    wp::array_t<wp::vec_t<4, wp::int32>> tile_bounds;
    wp::array_t<wp::float32> depths;
    wp::array_t<wp::int32> pair_counts;
    wp::array_t<wp::int32> pair_prefix;
    wp::array_t<wp::int32> group_ids;
    wp::array_t<wp::uint32> splat_ids;
    wp::int32 tiles_per_view;
    wp::int32 tiles_x;
    wp::array_t<wp::float32> depth_keys;
    wp::array_t<wp::uint64> packed_pairs;
};


void emit_projected_tile_pairs_79bf94b3_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_emit_projected_tile_pairs_79bf94b3 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<4, wp::int32>> var_tile_bounds = _wp_args->tile_bounds;
    wp::array_t<wp::float32> var_depths = _wp_args->depths;
    wp::array_t<wp::int32> var_pair_counts = _wp_args->pair_counts;
    wp::array_t<wp::int32> var_pair_prefix = _wp_args->pair_prefix;
    wp::array_t<wp::int32> var_group_ids = _wp_args->group_ids;
    wp::array_t<wp::uint32> var_splat_ids = _wp_args->splat_ids;
    wp::int32 var_tiles_per_view = _wp_args->tiles_per_view;
    wp::int32 var_tiles_x = _wp_args->tiles_x;
    wp::array_t<wp::float32> var_depth_keys = _wp_args->depth_keys;
    wp::array_t<wp::uint64> var_packed_pairs = _wp_args->packed_pairs;
    //---------
    // primal vars
    wp::int32 var_0;
...
// Python CPU entry points
WP_API void emit_projected_tile_pairs_79bf94b3_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_emit_projected_tile_pairs_79bf94b3 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        emit_projected_tile_pairs_79bf94b3_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_count_projected_tile_pairs_8bdf587e {
...
void count_projected_tile_pairs_8bdf587e_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_count_projected_tile_pairs_8bdf587e *_wp_args)
{
    //---------
    // argument vars
    ...
    wp::int32 var_count = _wp_args->count;
    wp::int32 var_width = _wp_args->width;
    wp::int32 var_height = _wp_args->height;
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_tiles_x = _wp_args->tiles_x;
...
// Python CPU entry points
WP_API void count_projected_tile_pairs_8bdf587e_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_count_projected_tile_pairs_8bdf587e *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        count_projected_tile_pairs_8bdf587e_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
