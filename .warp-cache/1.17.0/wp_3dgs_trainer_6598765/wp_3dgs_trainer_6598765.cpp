...
static wp::vec_t<3, wp::float32> conic_at_centre_0(
    wp::vec_t<3, wp::float32> var_log_scale,
    wp::vec_t<4, wp::float32> var_quaternion,
    wp::mat_t<4, 4, wp::float32> var_camera,
    wp::float32 var_x,
...
static wp::float32 alpha_at_pixel_0(
...
static wp::vec_t<3, wp::float32> colour_at_view_0(
...
// D:\NUS CS\Y3 S1\CP4282\cp4282-as2\3dgs_trainer.py:380
static void adj_conic_at_centre_0(
    wp::vec_t<3, wp::float32> var_log_scale,
    wp::vec_t<4, wp::float32> var_quaternion,
    wp::mat_t<4, 4, wp::float32> var_camera,
    wp::float32 var_x,
...
// D:\NUS CS\Y3 S1\CP4282\cp4282-as2\3dgs_trainer.py:388
static void adj_alpha_at_pixel_0(
    wp::vec_t<3, wp::float32> var_mean,
    wp::vec_t<3, wp::float32> var_log_scale,
    wp::vec_t<4, wp::float32> var_quaternion,
    wp::float32 var_opacity_logit,
...
// D:\NUS CS\Y3 S1\CP4282\cp4282-as2\3dgs_trainer.py:437
static void adj_colour_at_view_0(
    wp::vec_t<3, wp::float32> var_color,
...
struct wp_args_render_forward_11244831 {
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> color;
    wp::array_t<wp::mat_t<4, 4, wp::float32>> cameras;
    wp::array_t<wp::vec_t<3, wp::float32>> targets;
    wp::array_t<wp::int32> view_ids;
    wp::array_t<wp::int32> offsets;
    wp::array_t<wp::uint64> pairs;
    wp::int32 width;
    wp::int32 height;
    wp::int32 tiles_x;
    wp::int32 tiles_y;
    ...
    wp::float32 focal;
    wp::int32 view_count;
    wp::vec_t<3, wp::float32> background;
    wp::int32 compact_enabled;
    wp::float32 compact_beta;
    wp::float32 compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> image;
    wp::array_t<wp::float32> loss;
};


void render_forward_11244831_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_forward_11244831 *_wp_args)
{
    //---------
    // argument vars
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_color = _wp_args->color;
    wp::array_t<wp::mat_t<4, 4, wp::float32>> var_cameras = _wp_args->cameras;
    wp::array_t<wp::vec_t<3, wp::float32>> var_targets = _wp_args->targets;
    wp::array_t<wp::int32> var_view_ids = _wp_args->view_ids;
    wp::array_t<wp::int32> var_offsets = _wp_args->offsets;
    wp::array_t<wp::uint64> var_pairs = _wp_args->pairs;
    wp::int32 var_width = _wp_args->width;
    wp::int32 var_height = _wp_args->height;
    wp::int32 var_tiles_x = _wp_args->tiles_x;
    wp::int32 var_tiles_y = _wp_args->tiles_y;
    wp::int32 var_tile = _wp_args->tile;
    wp::float32 var_focal = _wp_args->focal;
    wp::int32 var_view_count = _wp_args->view_count;
    wp::vec_t<3, wp::float32> var_background = _wp_args->background;
    wp::int32 var_compact_enabled = _wp_args->compact_enabled;
    wp::float32 var_compact_beta = _wp_args->compact_beta;
    wp::float32 var_compact_alpha_min = _wp_args->compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
    wp::array_t<wp::float32> var_loss = _wp_args->loss;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    // rgb = wp.vec3(0.0, 0.0, 0.0)                                                           <L 482>
    var_28 = wp::vec_t<3, wp::float32>(var_25, var_26, var_27);
    // transmittance = float(1.0)                                                             <L 483>
    ...
    start_for_0:;
        ...
        goto start_for_0;
    end_for_0:;
    // rgb = rgb + transmittance * background                                                 <L 495>
    var_74 = wp::mul(var_30, var_background);
    var_75 = wp::add(var_28, var_74);
    // image[thread] = rgb                                                                    <L 496>
    wp::array_store(var_image, var_0, var_75);
    // difference = rgb - targets[view * pixels + pixel]                                      <L 497>
    ...
    // wp.atomic_add(loss, 0, wp.dot(difference, difference) / float(3 * pixels * view_count))       <L 498>
...
void render_forward_11244831_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_forward_11244831 *_wp_args,
    wp_args_render_forward_11244831 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
    wp::array_t<wp::float32> var_loss = _wp_args->loss;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_means = _wp_adj_args->means;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_log_scales = _wp_adj_args->log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> adj_quaternions = _wp_adj_args->quaternions;
    wp::array_t<wp::float32> adj_opacity_logits = _wp_adj_args->opacity_logits;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_color = _wp_adj_args->color;
    wp::array_t<wp::mat_t<4, 4, wp::float32>> adj_cameras = _wp_adj_args->cameras;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_targets = _wp_adj_args->targets;
    wp::array_t<wp::int32> adj_view_ids = _wp_adj_args->view_ids;
    wp::array_t<wp::int32> adj_offsets = _wp_adj_args->offsets;
    wp::array_t<wp::uint64> adj_pairs = _wp_adj_args->pairs;
    wp::int32 adj_width = _wp_adj_args->width;
    wp::int32 adj_height = _wp_adj_args->height;
    wp::int32 adj_tiles_x = _wp_adj_args->tiles_x;
    wp::int32 adj_tiles_y = _wp_adj_args->tiles_y;
    wp::int32 adj_tile = _wp_adj_args->tile;
    wp::float32 adj_focal = _wp_adj_args->focal;
    wp::int32 adj_view_count = _wp_adj_args->view_count;
    wp::vec_t<3, wp::float32> adj_background = _wp_adj_args->background;
    wp::int32 adj_compact_enabled = _wp_adj_args->compact_enabled;
    wp::float32 adj_compact_beta = _wp_adj_args->compact_beta;
    wp::float32 adj_compact_alpha_min = _wp_adj_args->compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_image = _wp_adj_args->image;
    wp::array_t<wp::float32> adj_loss = _wp_adj_args->loss;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    // adj: wp.atomic_add(loss, 0, wp.dot(difference, difference) / float(3 * pixels * view_count))  <L 498>
    ...
    start_for_0:;
        ...
        if (var_58) {
            ...
            // adj: if transmittance < TRANSMITTANCE_CUTOFF:                                  <L 493>
            wp::adj_mul(var_30, var_66, adj_30, adj_66, adj_67);
            wp::adj_sub(var_65, var_51, adj_65, adj_51, adj_66);
            // adj: transmittance = transmittance * (1.0 - alpha)                             <L 492>
            ...
            // adj: rgb = rgb + transmittance * alpha * colour                                <L 491>
            adj_colour_at_view_0(var_61, adj_59, adj_60);
            wp::adj_address(var_color, var_43, adj_color, adj_43, adj_59);
            // adj: colour = colour_at_view(color[splat])                                     <L 490>
        }
        // adj: if alpha > 0.0:                                                               <L 489>
    ...
    // adj: transmittance = float(1.0)                                                        <L 483>
    wp::adj_vec_t(var_25, var_26, var_27, adj_25, adj_26, adj_27, adj_28);
    // adj: rgb = wp.vec3(0.0, 0.0, 0.0)                                                      <L 482>
...
WP_API void render_forward_11244831_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_forward_11244831 *_wp_args)
{
    ...
    {
        render_forward_11244831_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void render_forward_11244831_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_forward_11244831 *_wp_args,
    wp_args_render_forward_11244831 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_forward_11244831_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_render_sparse_forward_25c85e28 {
    wp::array_t<wp::vec_t<3, wp::float32>> means;
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> opacity_logits;
    ...
    wp::array_t<wp::mat_t<4, 4, wp::float32>> cameras;
    wp::int32 view;
    wp::array_t<wp::vec_t<2, wp::int32>> sample_xy;
    wp::array_t<wp::int32> offsets;
    wp::array_t<wp::uint64> pairs;
    wp::int32 samples_per_tile;
    wp::int32 width;
    wp::int32 height;
    wp::float32 focal;
    wp::array_t<wp::vec_t<3, wp::float32>> sample_gt;
    wp::vec_t<3, wp::float32> background;
    wp::int32 num_samples;
    wp::int32 compact_enabled;
    wp::float32 compact_beta;
    wp::float32 compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> rendered_rgb;
    wp::array_t<wp::int32> last_contributor;
    wp::array_t<wp::float32> loss;
};


void render_sparse_forward_25c85e28_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_sparse_forward_25c85e28 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_color = _wp_args->color;
    wp::array_t<wp::mat_t<4, 4, wp::float32>> var_cameras = _wp_args->cameras;
    wp::int32 var_view = _wp_args->view;
    wp::array_t<wp::vec_t<2, wp::int32>> var_sample_xy = _wp_args->sample_xy;
    wp::array_t<wp::int32> var_offsets = _wp_args->offsets;
    wp::array_t<wp::uint64> var_pairs = _wp_args->pairs;
    wp::int32 var_samples_per_tile = _wp_args->samples_per_tile;
    wp::int32 var_width = _wp_args->width;
    wp::int32 var_height = _wp_args->height;
    wp::float32 var_focal = _wp_args->focal;
    wp::array_t<wp::vec_t<3, wp::float32>> var_sample_gt = _wp_args->sample_gt;
    wp::vec_t<3, wp::float32> var_background = _wp_args->background;
    wp::int32 var_num_samples = _wp_args->num_samples;
    wp::int32 var_compact_enabled = _wp_args->compact_enabled;
    wp::float32 var_compact_beta = _wp_args->compact_beta;
    wp::float32 var_compact_alpha_min = _wp_args->compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> var_rendered_rgb = _wp_args->rendered_rgb;
    wp::array_t<wp::int32> var_last_contributor = _wp_args->last_contributor;
    wp::array_t<wp::float32> var_loss = _wp_args->loss;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    start_for_0:;
        ...
        // splat = int(pairs[entry] & wp.uint64(0xFFFFFFFF))                                  <L 680>
        ...
        // alpha = alpha_at_pixel(                                                            <L 681>
        // means[splat], log_scales[splat], quaternions[splat], opacity_logits[splat],        <L 682>
        ...
        // camera, px, py, float(width), float(height), focal,                                <L 683>
        var_45 = wp::float(var_width);
        var_46 = wp::float(var_height);
        // compact_enabled, compact_beta, compact_alpha_min,                                  <L 684>
...
void render_sparse_forward_25c85e28_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_sparse_forward_25c85e28 *_wp_args,
    wp_args_render_sparse_forward_25c85e28 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_color = _wp_adj_args->color;
    wp::array_t<wp::mat_t<4, 4, wp::float32>> adj_cameras = _wp_adj_args->cameras;
    wp::int32 adj_view = _wp_adj_args->view;
    wp::array_t<wp::vec_t<2, wp::int32>> adj_sample_xy = _wp_adj_args->sample_xy;
    wp::array_t<wp::int32> adj_offsets = _wp_adj_args->offsets;
    wp::array_t<wp::uint64> adj_pairs = _wp_adj_args->pairs;
    wp::int32 adj_samples_per_tile = _wp_adj_args->samples_per_tile;
    wp::int32 adj_width = _wp_adj_args->width;
    wp::int32 adj_height = _wp_adj_args->height;
    wp::float32 adj_focal = _wp_adj_args->focal;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_sample_gt = _wp_adj_args->sample_gt;
    wp::vec_t<3, wp::float32> adj_background = _wp_adj_args->background;
    wp::int32 adj_num_samples = _wp_adj_args->num_samples;
    wp::int32 adj_compact_enabled = _wp_adj_args->compact_enabled;
    wp::float32 adj_compact_beta = _wp_adj_args->compact_beta;
    wp::float32 adj_compact_alpha_min = _wp_adj_args->compact_alpha_min;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_rendered_rgb = _wp_adj_args->rendered_rgb;
    wp::array_t<wp::int32> adj_last_contributor = _wp_adj_args->last_contributor;
    wp::array_t<wp::float32> adj_loss = _wp_adj_args->loss;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    start_for_0:;
        ...
        if (var_53) {
            ...
            // adj: rgb = rgb + transmittance * alpha * colour                                <L 688>
            adj_colour_at_view_0(var_56, adj_54, adj_55);
            wp::adj_address(var_color, var_40, adj_color, adj_40, adj_54);
            // adj: colour = colour_at_view(color[splat])                                     <L 687>
        }
        // adj: if alpha > 0.0:                                                               <L 686>
        ...
        // adj: compact_enabled, compact_beta, compact_alpha_min,                             <L 684>
        wp::adj_float(var_height, adj_height, adj_46);
        wp::adj_float(var_width, adj_width, adj_45);
        // adj: camera, px, py, float(width), float(height), focal,                           <L 683>
        ...
        // adj: means[splat], log_scales[splat], quaternions[splat], opacity_logits[splat],   <L 682>
        // adj: alpha = alpha_at_pixel(                                                       <L 681>
        wp::adj_address(var_pairs, var_35, adj_pairs, adj_35, adj_36);
        // adj: splat = int(pairs[entry] & wp.uint64(0xFFFFFFFF))                             <L 680>
    	goto start_for_0;
    end_for_0:;
...
// Python CPU entry points
WP_API void render_sparse_forward_25c85e28_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_sparse_forward_25c85e28 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_sparse_forward_25c85e28_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void render_sparse_forward_25c85e28_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_sparse_forward_25c85e28 *_wp_args,
    wp_args_render_sparse_forward_25c85e28 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_sparse_forward_25c85e28_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_gather_sample_targets_4043906f {
    wp::array_t<wp::vec_t<3, wp::float32>> targets;
    wp::array_t<wp::vec_t<2, wp::int32>> sample_xy;
    wp::int32 view;
    wp::int32 width;
...
void gather_sample_targets_4043906f_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_gather_sample_targets_4043906f *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_targets = _wp_args->targets;
    ...
    //---------
    // forward
    // def gather_sample_targets(                                                             <L 618>
    // sample = wp.tid()                                                                      <L 626>
    var_0 = builtin_tid1d();
    // xy = sample_xy[sample]                                                                 <L 627>
    var_1 = wp::address(var_sample_xy, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // sample_gt[sample] = targets[view * width * height + xy[1] * width + xy[0]]             <L 628>
...
void gather_sample_targets_4043906f_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_gather_sample_targets_4043906f *_wp_args,
    wp_args_gather_sample_targets_4043906f *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_targets = _wp_args->targets;
    ...
    // adj: sample_gt[sample] = targets[view * width * height + xy[1] * width + xy[0]]        <L 628>
    wp::adj_copy(var_3, adj_1, adj_2);
    wp::adj_address(var_sample_xy, var_0, adj_sample_xy, adj_0, adj_1);
    // adj: xy = sample_xy[sample]                                                            <L 627>
    // adj: sample = wp.tid()                                                                 <L 626>
    // adj: def gather_sample_targets(                                                        <L 618>
    return;
}
...
// Python CPU entry points
WP_API void gather_sample_targets_4043906f_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_gather_sample_targets_4043906f *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        gather_sample_targets_4043906f_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void gather_sample_targets_4043906f_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_gather_sample_targets_4043906f *_wp_args,
    wp_args_gather_sample_targets_4043906f *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        gather_sample_targets_4043906f_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_mse_pixel_gradient_73e11ede {
    wp::array_t<wp::vec_t<3, wp::float32>> image;
    ...
    wp::int32 height;
    wp::int32 view_count;
    wp::array_t<wp::vec_t<3, wp::float32>> pixel_gradient;
};


void mse_pixel_gradient_73e11ede_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_mse_pixel_gradient_73e11ede *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
    ...
    wp::int32 var_height = _wp_args->height;
    wp::int32 var_view_count = _wp_args->view_count;
    wp::array_t<wp::vec_t<3, wp::float32>> var_pixel_gradient = _wp_args->pixel_gradient;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    //---------
    // forward
    // def mse_pixel_gradient(                                                                <L 594>
    // thread = wp.tid()                                                                      <L 608>
    var_0 = builtin_tid1d();
    // pixels = width * height                                                                <L 609>
    var_1 = wp::mul(var_width, var_height);
    // batch_view = thread // pixels                                                          <L 610>
    var_2 = wp::floordiv(var_0, var_1);
    // pixel = thread - batch_view * pixels                                                   <L 611>
    var_3 = wp::mul(var_2, var_1);
    var_4 = wp::sub(var_0, var_3);
    // target_pixel = view_ids[batch_view] * pixels + pixel                                   <L 612>
    var_5 = wp::address(var_view_ids, var_2);
    var_7 = wp::load(var_5);
    var_6 = wp::mul(var_7, var_1);
    var_8 = wp::add(var_6, var_4);
    // difference = image[thread] - target[target_pixel]                                      <L 613>
    ...
    // pixel_gradient[thread] = difference * (2.0 / float(3 * pixels * view_count))           <L 614>
...
void mse_pixel_gradient_73e11ede_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_mse_pixel_gradient_73e11ede *_wp_args,
    wp_args_mse_pixel_gradient_73e11ede *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
    ...
    wp::int32 adj_height = _wp_adj_args->height;
    wp::int32 adj_view_count = _wp_adj_args->view_count;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_pixel_gradient = _wp_adj_args->pixel_gradient;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    // adj: pixel_gradient[thread] = difference * (2.0 / float(3 * pixels * view_count))      <L 614>
    ...
    // adj: difference = image[thread] - target[target_pixel]                                 <L 613>
    ...
    // adj: target_pixel = view_ids[batch_view] * pixels + pixel                              <L 612>
    wp::adj_sub(var_0, var_3, adj_0, adj_3, adj_4);
    wp::adj_mul(var_2, var_1, adj_2, adj_1, adj_3);
    // adj: pixel = thread - batch_view * pixels                                              <L 611>
    // adj: batch_view = thread // pixels                                                     <L 610>
    wp::adj_mul(var_width, var_height, adj_width, adj_height, adj_1);
    // adj: pixels = width * height                                                           <L 609>
    // adj: thread = wp.tid()                                                                 <L 608>
    // adj: def mse_pixel_gradient(                                                           <L 594>
    return;
}
...
// Python CPU entry points
WP_API void mse_pixel_gradient_73e11ede_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_mse_pixel_gradient_73e11ede *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mse_pixel_gradient_73e11ede_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void mse_pixel_gradient_73e11ede_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_mse_pixel_gradient_73e11ede *_wp_args,
    wp_args_mse_pixel_gradient_73e11ede *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mse_pixel_gradient_73e11ede_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_render_sparse_backward_a1ba08ca {
    wp::array_t<wp::vec_t<3, wp::float32>> means;
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> opacity_logits;
    ...
    wp::float32 compact_beta;
    wp::float32 compact_alpha_min;
    wp::array_t<wp::float32> mean_grad_flat;
    wp::array_t<wp::float32> scale_grad_flat;
    wp::array_t<wp::float32> quaternion_grad_flat;
    wp::array_t<wp::float32> opacity_grad;
    wp::array_t<wp::float32> color_grad_flat;
};


void render_sparse_backward_a1ba08ca_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_sparse_backward_a1ba08ca *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
    ...
    wp::float32 var_compact_beta = _wp_args->compact_beta;
    wp::float32 var_compact_alpha_min = _wp_args->compact_alpha_min;
    wp::array_t<wp::float32> var_mean_grad_flat = _wp_args->mean_grad_flat;
    wp::array_t<wp::float32> var_scale_grad_flat = _wp_args->scale_grad_flat;
    wp::array_t<wp::float32> var_quaternion_grad_flat = _wp_args->quaternion_grad_flat;
    wp::array_t<wp::float32> var_opacity_grad = _wp_args->opacity_grad;
    wp::array_t<wp::float32> var_color_grad_flat = _wp_args->color_grad_flat;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    //---------
    // forward
    // def render_sparse_backward(                                                            <L 701>
    // thread = wp.tid()                                                                      <L 728>
    var_0 = builtin_tid1d();
    // record = thread // samples_per_tile                                                    <L 729>
    var_1 = wp::floordiv(var_0, var_samples_per_tile);
    // xy = sample_xy[thread]                                                                 <L 730>
    var_2 = wp::address(var_sample_xy, var_0);
    var_4 = wp::load(var_2);
    var_3 = wp::copy(var_4);
    // px = float(xy[0]) + 0.5                                                                <L 731>
    var_6 = wp::extract(var_3, var_5);
    var_7 = wp::float(var_6);
    var_9 = wp::add(var_7, var_8);
    // py = float(xy[1]) + 0.5                                                                <L 732>
    var_11 = wp::extract(var_3, var_10);
    var_12 = wp::float(var_11);
    var_14 = wp::add(var_12, var_13);
    // camera = cameras[view]                                                                 <L 733>
    var_15 = wp::address(var_cameras, var_view);
    var_17 = wp::load(var_15);
    var_16 = wp::copy(var_17);
    // final_rgb = rendered_rgb[thread]                                                       <L 734>
    var_18 = wp::address(var_rendered_rgb, var_0);
    var_20 = wp::load(var_18);
    var_19 = wp::copy(var_20);
    // pixel_grad = pixel_gradient[thread]                                                    <L 735>
    var_21 = wp::address(var_pixel_gradient, var_0);
    var_23 = wp::load(var_21);
    var_22 = wp::copy(var_23);
    // prefix_rgb = wp.vec3(0.0, 0.0, 0.0)                                                    <L 736>
    var_27 = wp::vec_t<3, wp::float32>(var_24, var_25, var_26);
    // transmittance = float(1.0)                                                             <L 737>
    var_29 = wp::float(var_28);
    // stop = last_contributor[thread]                                                        <L 738>
    var_30 = wp::address(var_last_contributor, var_0);
    var_32 = wp::load(var_30);
    var_31 = wp::copy(var_32);
    // for entry in range(offsets[record], stop + 1):                                         <L 739>
    ...
    start_for_0:;
        ...
        // splat = int(pairs[entry] & wp.uint64(0xFFFFFFFF))                                  <L 740>
        var_39 = wp::address(var_pairs, var_38);
        var_40 = 4294967295ull;
        var_42 = wp::load(var_39);
        var_41 = wp::bit_and(var_42, var_40);
        var_43 = wp::int(var_41);
        // mean = means[splat]                                                                <L 741>
        var_44 = wp::address(var_means, var_43);
        var_46 = wp::load(var_44);
        var_45 = wp::copy(var_46);
        // log_scale = log_scales[splat]                                                      <L 742>
        var_47 = wp::address(var_log_scales, var_43);
        var_49 = wp::load(var_47);
        var_48 = wp::copy(var_49);
        // quaternion = quaternions[splat]                                                    <L 743>
        var_50 = wp::address(var_quaternions, var_43);
        var_52 = wp::load(var_50);
        var_51 = wp::copy(var_52);
        // opacity_logit = opacity_logits[splat]                                              <L 744>
        var_53 = wp::address(var_opacity_logits, var_43);
        var_55 = wp::load(var_53);
        var_54 = wp::copy(var_55);
        // alpha = alpha_at_pixel(                                                            <L 745>
        // mean, log_scale, quaternion, opacity_logit, camera,                                <L 746>
        // px, py, float(width), float(height), focal,                                        <L 747>
        var_56 = wp::float(var_width);
        var_57 = wp::float(var_height);
        // compact_enabled, compact_beta, compact_alpha_min,                                  <L 748>
...
// Python CPU entry points
WP_API void render_sparse_backward_a1ba08ca_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_sparse_backward_a1ba08ca *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_sparse_backward_a1ba08ca_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_constrain_parameters_ad4aef34 {
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<3, wp::float32>> color;
    wp::float32 minimum_log_scale;
    wp::float32 maximum_log_scale;
};


void constrain_parameters_ad4aef34_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_constrain_parameters_ad4aef34 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_log_scales = _wp_args->log_scales;
    wp::array_t<wp::vec_t<3, wp::float32>> var_color = _wp_args->color;
    wp::float32 var_minimum_log_scale = _wp_args->minimum_log_scale;
    wp::float32 var_maximum_log_scale = _wp_args->maximum_log_scale;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def constrain_parameters(                                                              <L 802>
    // i = wp.tid()                                                                           <L 808>
    var_0 = builtin_tid1d();
    // scale = log_scales[i]                                                                  <L 809>
    var_1 = wp::address(var_log_scales, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // log_scales[i] = wp.vec3(                                                               <L 810>
    // wp.clamp(scale[0], minimum_log_scale, maximum_log_scale),                              <L 811>
    var_5 = wp::extract(var_2, var_4);
    var_6 = wp::clamp(var_5, var_minimum_log_scale, var_maximum_log_scale);
    // wp.clamp(scale[1], minimum_log_scale, maximum_log_scale),                              <L 812>
    var_8 = wp::extract(var_2, var_7);
    var_9 = wp::clamp(var_8, var_minimum_log_scale, var_maximum_log_scale);
    // wp.clamp(scale[2], minimum_log_scale, maximum_log_scale),                              <L 813>
    var_11 = wp::extract(var_2, var_10);
...
void constrain_parameters_ad4aef34_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_constrain_parameters_ad4aef34 *_wp_args,
    wp_args_constrain_parameters_ad4aef34 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_log_scales = _wp_args->log_scales;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_log_scales = _wp_adj_args->log_scales;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_color = _wp_adj_args->color;
    wp::float32 adj_minimum_log_scale = _wp_adj_args->minimum_log_scale;
    wp::float32 adj_maximum_log_scale = _wp_adj_args->maximum_log_scale;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::vec_t<3, wp::float32>* var_1;
    ...
    wp::adj_extract(var_2, var_10, adj_2, adj_10, adj_11);
    // adj: wp.clamp(scale[2], minimum_log_scale, maximum_log_scale),                         <L 813>
    ...
    // adj: wp.clamp(scale[1], minimum_log_scale, maximum_log_scale),                         <L 812>
    ...
    // adj: wp.clamp(scale[0], minimum_log_scale, maximum_log_scale),                         <L 811>
    // adj: log_scales[i] = wp.vec3(                                                          <L 810>
    wp::adj_copy(var_3, adj_1, adj_2);
    wp::adj_address(var_log_scales, var_0, adj_log_scales, adj_0, adj_1);
    // adj: scale = log_scales[i]                                                             <L 809>
    // adj: i = wp.tid()                                                                      <L 808>
    // adj: def constrain_parameters(                                                         <L 802>
    return;
}
...
// Python CPU entry points
WP_API void constrain_parameters_ad4aef34_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_constrain_parameters_ad4aef34 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        constrain_parameters_ad4aef34_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void constrain_parameters_ad4aef34_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_constrain_parameters_ad4aef34 *_wp_args,
    wp_args_constrain_parameters_ad4aef34 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        constrain_parameters_ad4aef34_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_sparse_mse_pixel_gradient_c7e18c15 {
    wp::array_t<wp::vec_t<3, wp::float32>> rendered_rgb;
    wp::array_t<wp::vec_t<3, wp::float32>> sample_gt;
    wp::int32 num_samples;
    wp::array_t<wp::vec_t<3, wp::float32>> pixel_gradient;
...
void sparse_mse_pixel_gradient_c7e18c15_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_rendered_rgb = _wp_args->rendered_rgb;
    ...
    //---------
    // forward
    // def sparse_mse_pixel_gradient(                                                         <L 632>
    // sample = wp.tid()                                                                      <L 638>
    var_0 = builtin_tid1d();
    // pixel_gradient[sample] = 2.0 * (rendered_rgb[sample] - sample_gt[sample]) / float(       <L 639>
...
void sparse_mse_pixel_gradient_c7e18c15_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_args,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_rendered_rgb = _wp_args->rendered_rgb;
    ...
    // adj: pixel_gradient[sample] = 2.0 * (rendered_rgb[sample] - sample_gt[sample]) / float(  <L 639>
    ...
    // adj: pixel_gradient[sample] = 2.0 * (rendered_rgb[sample] - sample_gt[sample]) / float(  <L 639>
    // adj: sample = wp.tid()                                                                 <L 638>
    // adj: def sparse_mse_pixel_gradient(                                                    <L 632>
    return;
}
...
// Python CPU entry points
WP_API void sparse_mse_pixel_gradient_c7e18c15_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        sparse_mse_pixel_gradient_c7e18c15_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void sparse_mse_pixel_gradient_c7e18c15_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_args,
    wp_args_sparse_mse_pixel_gradient_c7e18c15 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        sparse_mse_pixel_gradient_c7e18c15_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_pack_vec3_gradient_e4e3849b {
    wp::array_t<wp::float32> flat;
    wp::array_t<wp::vec_t<3, wp::float32>> packed;
};


void pack_vec3_gradient_e4e3849b_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_flat = _wp_args->flat;
    wp::array_t<wp::vec_t<3, wp::float32>> var_packed = _wp_args->packed;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def pack_vec3_gradient(flat: wp.array(dtype=wp.float32), packed: wp.array(dtype=wp.vec3)):       <L 770>
    // i = wp.tid()                                                                           <L 771>
    var_0 = builtin_tid1d();
    // packed[i] = wp.vec3(flat[i * 3], flat[i * 3 + 1], flat[i * 3 + 2])                     <L 772>
...
void pack_vec3_gradient_e4e3849b_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_args,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_flat = _wp_args->flat;
    wp::array_t<wp::vec_t<3, wp::float32>> var_packed = _wp_args->packed;
    wp::array_t<wp::float32> adj_flat = _wp_adj_args->flat;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_packed = _wp_adj_args->packed;
    //---------
    // primal vars
    wp::int32 var_0;
    const wp::int32 var_1 = 3;
    ...
    // adj: packed[i] = wp.vec3(flat[i * 3], flat[i * 3 + 1], flat[i * 3 + 2])                <L 772>
    // adj: i = wp.tid()                                                                      <L 771>
    // adj: def pack_vec3_gradient(flat: wp.array(dtype=wp.float32), packed: wp.array(dtype=wp.vec3)):  <L 770>
    return;
}
...
// Python CPU entry points
WP_API void pack_vec3_gradient_e4e3849b_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        pack_vec3_gradient_e4e3849b_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void pack_vec3_gradient_e4e3849b_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_args,
    wp_args_pack_vec3_gradient_e4e3849b *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        pack_vec3_gradient_e4e3849b_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_render_backward_e78f6037 {
    wp::array_t<wp::vec_t<3, wp::float32>> means;
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> opacity_logits;
...
void render_backward_e78f6037_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_backward_e78f6037 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
    ...
    wp::vec_t<3, wp::float32> var_78;
    wp::float32 var_79;
    const wp::float32 var_80 = 0.0001;
    bool var_81;
    ...
    //---------
    // forward
    // def render_backward(                                                                   <L 502>
    // thread = wp.tid()                                                                      <L 529>
    var_0 = builtin_tid1d();
    // pixels = width * height                                                                <L 530>
    var_1 = wp::mul(var_width, var_height);
    // batch_view = thread // pixels                                                          <L 531>
    var_2 = wp::floordiv(var_0, var_1);
    // view = view_ids[batch_view]                                                            <L 532>
    var_3 = wp::address(var_view_ids, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // pixel = thread - batch_view * pixels                                                   <L 533>
    var_6 = wp::mul(var_2, var_1);
    var_7 = wp::sub(var_0, var_6);
    // px = float(pixel % width) + 0.5                                                        <L 534>
    var_8 = wp::mod(var_7, var_width);
    var_9 = wp::float(var_8);
    var_11 = wp::add(var_9, var_10);
    // py = float(pixel // width) + 0.5                                                       <L 535>
    var_12 = wp::floordiv(var_7, var_width);
    var_13 = wp::float(var_12);
    var_15 = wp::add(var_13, var_14);
    // record = batch_view * tiles_x * tiles_y + (pixel // width // tile) * tiles_x + (pixel % width // tile)       <L 536>
    var_16 = wp::mul(var_2, var_tiles_x);
    var_17 = wp::mul(var_16, var_tiles_y);
    var_18 = wp::floordiv(var_7, var_width);
    var_19 = wp::floordiv(var_18, var_tile);
    ...
    start_for_0:;
        ...
        // splat = int(pairs[entry] & wp.uint64(0xFFFFFFFF))                                  <L 545>
        ...
        // mean = means[splat]                                                                <L 546>
        var_50 = wp::address(var_means, var_49);
        var_52 = wp::load(var_50);
        var_51 = wp::copy(var_52);
        // log_scale = log_scales[splat]                                                      <L 547>
        var_53 = wp::address(var_log_scales, var_49);
        var_55 = wp::load(var_53);
        var_54 = wp::copy(var_55);
        // quaternion = quaternions[splat]                                                    <L 548>
        var_56 = wp::address(var_quaternions, var_49);
        var_58 = wp::load(var_56);
        var_57 = wp::copy(var_58);
        // opacity_logit = opacity_logits[splat]                                              <L 549>
        var_59 = wp::address(var_opacity_logits, var_49);
        var_61 = wp::load(var_59);
        var_60 = wp::copy(var_61);
        // camera = cameras[view]                                                             <L 550>
        var_62 = wp::address(var_cameras, var_4);
        var_64 = wp::load(var_62);
        var_63 = wp::copy(var_64);
        // alpha = alpha_at_pixel(mean, log_scale, quaternion, opacity_logit, camera,         <L 551>
        // px, py, float(width), float(height), focal, compact_enabled, compact_beta, compact_alpha_min)       <L 552>
        ...
        var_69 = (var_67 > var_68);
        if (var_69) {
            // colour = colour_at_view(color[splat])                                          <L 554>
            var_70 = wp::address(var_color, var_49);
            var_72 = wp::load(var_70);
            var_71 = colour_at_view_0(var_72);
            // next_transmittance = transmittance * (1.0 - alpha)                             <L 555>
            var_74 = wp::sub(var_73, var_67);
            var_75 = wp::mul(var_36, var_74);
            // prefix_rgb = prefix_rgb + transmittance * alpha * colour                       <L 587>
            var_76 = wp::mul(var_36, var_67);
            var_77 = wp::mul(var_76, var_71);
            var_78 = wp::add(var_34, var_77);
            // transmittance = next_transmittance                                             <L 588>
            var_79 = wp::copy(var_75);
            // if transmittance < TRANSMITTANCE_CUTOFF:                                       <L 589>
            var_81 = (var_79 < var_80);
            if (var_81) {
                // break                                                                      <L 590>
                wp::assign(var_34, var_78);
                wp::assign(var_36, var_79);
                goto end_for_0;
            }
            var_82 = wp::where(var_81, var_34, var_78);
            var_83 = wp::where(var_81, var_36, var_79);
        }
        var_84 = wp::where(var_69, var_82, var_34);
        var_85 = wp::where(var_69, var_83, var_36);
        wp::assign(var_34, var_84);
        wp::assign(var_36, var_85);
        goto start_for_0;
    end_for_0:;
}
...
// Python CPU entry points
WP_API void render_backward_e78f6037_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_backward_e78f6037 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_backward_e78f6037_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_adam_quaternion_step_fb5bfef0 {
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> gradients;
    wp::array_t<wp::vec_t<4, wp::float32>> m;
    wp::array_t<wp::vec_t<4, wp::float32>> v;
    wp::float32 lr;
    wp::float32 beta1;
    wp::float32 beta2;
    wp::float32 t;
...
void adam_quaternion_step_fb5bfef0_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<4, wp::float32>> var_quaternions = _wp_args->quaternions;
    wp::array_t<wp::float32> var_gradients = _wp_args->gradients;
    wp::array_t<wp::vec_t<4, wp::float32>> var_m = _wp_args->m;
    wp::array_t<wp::vec_t<4, wp::float32>> var_v = _wp_args->v;
    wp::float32 var_lr = _wp_args->lr;
    wp::float32 var_beta1 = _wp_args->beta1;
    wp::float32 var_beta2 = _wp_args->beta2;
    wp::float32 var_t = _wp_args->t;
    wp::float32 var_eps = _wp_args->eps;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def adam_quaternion_step(                                                              <L 776>
    // i = wp.tid()                                                                           <L 789>
    var_0 = builtin_tid1d();
    // g = wp.vec4(gradients[i * 4], gradients[i * 4 + 1], gradients[i * 4 + 2], gradients[i * 4 + 3])       <L 790>
    var_2 = wp::mul(var_0, var_1);
    ...
    // m[i] = beta1 * m[i] + (1.0 - beta1) * g                                                <L 791>
    ...
    // v[i] = beta2 * v[i] + (1.0 - beta2) * wp.cw_mul(g, g)                                  <L 792>
    ...
    // mhat = m[i] / (1.0 - wp.pow(beta1, t + 1.0))                                           <L 793>
    ...
    // vhat = v[i] / (1.0 - wp.pow(beta2, t + 1.0))                                           <L 794>
    ...
    // sqrt_vhat = wp.vec4(wp.sqrt(vhat[0]), wp.sqrt(vhat[1]), wp.sqrt(vhat[2]), wp.sqrt(vhat[3]))       <L 795>
    ...
    // eps_vec4 = wp.vec4(eps, eps, eps, eps)                                                 <L 796>
    var_68 = wp::vec_t<4, wp::float32>(var_eps, var_eps, var_eps, var_eps);
    // q = quaternions[i] - lr * wp.cw_div(mhat, (sqrt_vhat + eps_vec4))                      <L 797>
    ...
    // quaternions[i] = q / wp.sqrt(wp.dot(q, q) + 1.0e-8)                                    <L 798>
...
void adam_quaternion_step_fb5bfef0_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_args,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<4, wp::float32>> var_quaternions = _wp_args->quaternions;
    ...
    wp::float32 var_eps = _wp_args->eps;
    wp::array_t<wp::vec_t<4, wp::float32>> adj_quaternions = _wp_adj_args->quaternions;
    wp::array_t<wp::float32> adj_gradients = _wp_adj_args->gradients;
    wp::array_t<wp::vec_t<4, wp::float32>> adj_m = _wp_adj_args->m;
    wp::array_t<wp::vec_t<4, wp::float32>> adj_v = _wp_adj_args->v;
    wp::float32 adj_lr = _wp_adj_args->lr;
    wp::float32 adj_beta1 = _wp_adj_args->beta1;
    wp::float32 adj_beta2 = _wp_adj_args->beta2;
    wp::float32 adj_t = _wp_adj_args->t;
    wp::float32 adj_eps = _wp_adj_args->eps;
    //---------
    // primal vars
    wp::int32 var_0;
    const wp::int32 var_1 = 4;
    ...
    // adj: quaternions[i] = q / wp.sqrt(wp.dot(q, q) + 1.0e-8)                               <L 798>
    ...
    // adj: q = quaternions[i] - lr * wp.cw_div(mhat, (sqrt_vhat + eps_vec4))                 <L 797>
    wp::adj_vec_t(var_eps, var_eps, var_eps, var_eps, adj_eps, adj_eps, adj_eps, adj_eps, adj_68);
    // adj: eps_vec4 = wp.vec4(eps, eps, eps, eps)                                            <L 796>
    ...
    // adj: sqrt_vhat = wp.vec4(wp.sqrt(vhat[0]), wp.sqrt(vhat[1]), wp.sqrt(vhat[2]), wp.sqrt(vhat[3]))  <L 795>
    ...
    // adj: vhat = v[i] / (1.0 - wp.pow(beta2, t + 1.0))                                      <L 794>
    ...
    // adj: mhat = m[i] / (1.0 - wp.pow(beta1, t + 1.0))                                      <L 793>
    ...
    // adj: v[i] = beta2 * v[i] + (1.0 - beta2) * wp.cw_mul(g, g)                             <L 792>
    ...
    // adj: m[i] = beta1 * m[i] + (1.0 - beta1) * g                                           <L 791>
    ...
    wp::adj_mul(var_0, var_1, adj_0, adj_1, adj_2);
    // adj: g = wp.vec4(gradients[i * 4], gradients[i * 4 + 1], gradients[i * 4 + 2], gradients[i * 4 + 3])  <L 790>
    // adj: i = wp.tid()                                                                      <L 789>
    // adj: def adam_quaternion_step(                                                         <L 776>
    return;
}
...
// Python CPU entry points
WP_API void adam_quaternion_step_fb5bfef0_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        adam_quaternion_step_fb5bfef0_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void adam_quaternion_step_fb5bfef0_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_args,
    wp_args_adam_quaternion_step_fb5bfef0 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        adam_quaternion_step_fb5bfef0_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
