...
extern "C" __global__ void project_tile_records_595de004_cuda_kernel_forward(
    ...
    wp::array_t<wp::int32> var_active,
    ...
    wp::int32 var_compact_box_enabled,
    wp::float32 var_compact_box_beta,
    wp::float32 var_compact_box_alpha_min,
