    ...
    wp::float32 var_maximum_log_scale)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def constrain_parameters(                                                              <L 1062>
        // i = wp.tid()                                                                           <L 1068>
        var_0 = builtin_tid1d();
        // scale = log_scales[i]                                                                  <L 1069>
        var_1 = wp::address(var_log_scales, var_0);
        var_3 = wp::load(var_1);
        var_2 = wp::copy(var_3);
        // log_scales[i] = wp.vec3(                                                               <L 1070>
        // wp.clamp(scale[0], minimum_log_scale, maximum_log_scale),                              <L 1071>
        var_5 = wp::extract(var_2, var_4);
        var_6 = wp::clamp(var_5, var_minimum_log_scale, var_maximum_log_scale);
        // wp.clamp(scale[1], minimum_log_scale, maximum_log_scale),                              <L 1072>
        var_8 = wp::extract(var_2, var_7);
        var_9 = wp::clamp(var_8, var_minimum_log_scale, var_maximum_log_scale);
        // wp.clamp(scale[2], minimum_log_scale, maximum_log_scale),                              <L 1073>
        var_11 = wp::extract(var_2, var_10);
    ...
    wp::float32 adj_maximum_log_scale)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::adj_extract(var_2, var_10, adj_2, adj_10, adj_11);
        // adj: wp.clamp(scale[2], minimum_log_scale, maximum_log_scale),                         <L 1073>
        ...
        // adj: wp.clamp(scale[1], minimum_log_scale, maximum_log_scale),                         <L 1072>
        ...
        // adj: wp.clamp(scale[0], minimum_log_scale, maximum_log_scale),                         <L 1071>
        // adj: log_scales[i] = wp.vec3(                                                          <L 1070>
        wp::adj_copy(var_3, adj_1, adj_2);
        wp::adj_address(var_log_scales, var_0, adj_log_scales, adj_0, adj_1);
        // adj: scale = log_scales[i]                                                             <L 1069>
        // adj: i = wp.tid()                                                                      <L 1068>
        // adj: def constrain_parameters(                                                         <L 1062>
        continue;
    }
}
...
extern "C" __global__ void render_sparse_backward_b31c528e_cuda_kernel_forward(
    wp::launch_bounds_t<1> dim,
    wp::array_t<wp::vec_t<3, wp::float32>> var_means,
    wp::array_t<wp::vec_t<3, wp::float32>> var_log_scales,
    wp::array_t<wp::vec_t<4, wp::float32>> var_quaternions,
    ...
    wp::array_t<wp::float32> var_color_grad_flat)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::float32 var_120;
        wp::mat_t<4, 4, wp::float32> var_121;
        wp::float32 var_122;
        wp::float32 var_123;
        wp::float32 var_124;
        wp::float32 var_125;
        ...
        wp::float32 var_129;
        wp::float32 var_130;
        wp::tuple_t<wp::vec_t<3, wp::float32>, wp::vec_t<3, wp::float32>, wp::vec_t<4, wp::float32>, float, wp::mat_t<4, 4, wp::float32>, float, float, float, float, float, int, float, float> var_131;
        ...
        wp::vec_t<4, wp::float32> var_137;
        const wp::int32 var_138 = 3;
        wp::float32 var_139;
        const wp::int32 var_140 = 4;
        wp::mat_t<4, 4, wp::float32> var_141;
        const wp::int32 var_142 = 5;
        wp::float32 var_143;
        ...
        wp::float32 var_149;
        const wp::int32 var_150 = 9;
        wp::float32 var_151;
        const wp::int32 var_152 = 10;
        wp::int32 var_153;
        const wp::int32 var_154 = 11;
        wp::float32 var_155;
        const wp::int32 var_156 = 12;
        wp::float32 var_157;
        ...
        start_for_0:;
            ...
            if (var_60) {
                ...
                // final_rgb                                                                      <L 899>
                // - prefix_rgb                                                                   <L 900>
                var_67 = wp::sub(var_19, var_27);
                // - transmittance * alpha * colour                                               <L 901>
                var_68 = wp::mul(var_29, var_58);
                var_69 = wp::mul(var_68, var_62);
                var_70 = wp::sub(var_67, var_69);
                // ) / wp.max(next_transmittance, 1.0e-8)                                         <L 902>
                var_72 = wp::max(var_66, var_71);
                var_73 = wp::div(var_70, var_72);
                // colour_adjoint = transmittance * alpha * pixel_grad                            <L 904>
                var_74 = wp::mul(var_29, var_58);
                var_75 = wp::mul(var_74, var_22);
                // raw_colour = color[splat]                                                      <L 906>
                var_76 = wp::address(var_color, var_43);
                var_78 = wp::load(var_76);
                var_77 = wp::copy(var_78);
                // if raw_colour[0] <= 0.0 or raw_colour[0] >= 1.0:                               <L 908>
                var_81 = wp::extract(var_77, var_80);
                var_83 = (var_81 <= var_82);
                var_79 = var_83;
                if (!var_79) {
                    var_85 = wp::extract(var_77, var_84);
                    var_87 = (var_85 >= var_86);
                    var_79 = var_79 || var_87;
                }
                if (var_79) {
                    // colour_adjoint[0] = 0.0                                                    <L 909>
                    wp::assign_inplace(var_75, var_89, var_88);
                }
                // if raw_colour[1] <= 0.0 or raw_colour[1] >= 1.0:                               <L 910>
                var_92 = wp::extract(var_77, var_91);
                var_94 = (var_92 <= var_93);
                var_90 = var_94;
                if (!var_90) {
                    var_96 = wp::extract(var_77, var_95);
                    var_98 = (var_96 >= var_97);
                    var_90 = var_90 || var_98;
                }
                if (var_90) {
                    // colour_adjoint[1] = 0.0                                                    <L 911>
                    wp::assign_inplace(var_75, var_100, var_99);
                }
                // if raw_colour[2] <= 0.0 or raw_colour[2] >= 1.0:                               <L 912>
                var_103 = wp::extract(var_77, var_102);
                var_105 = (var_103 <= var_104);
                var_101 = var_105;
                if (!var_101) {
                    var_107 = wp::extract(var_77, var_106);
                    var_109 = (var_107 >= var_108);
                    var_101 = var_101 || var_109;
                }
                if (var_101) {
                    // colour_adjoint[2] = 0.0                                                    <L 913>
                    wp::assign_inplace(var_75, var_111, var_110);
                }
                // alpha_adjoint = transmittance * wp.dot(                                        <L 915>
                // pixel_grad,                                                                    <L 916>
                // colour - remaining_rgb,                                                        <L 917>
                var_112 = wp::sub(var_62, var_73);
                var_113 = wp::dot(var_22, var_112);
                var_114 = wp::mul(var_29, var_113);
                // (                                                                              <L 920>
                // ) = wp.grad(alpha_at_pixel)(                                                   <L 934>
                // mean,                                                                          <L 935>
                // log_scale,                                                                     <L 936>
                // quaternion,                                                                    <L 937>
                // opacity_logit,                                                                 <L 938>
                ...
                // py,                                                                            <L 941>
                // float(width),                                                                  <L 942>
                var_115 = wp::float(var_width);
                // float(height),                                                                 <L 943>
                var_116 = wp::float(var_height);
                // focal,                                                                         <L 944>
                // compact_enabled,                                                               <L 945>
                // compact_beta,                                                                  <L 946>
                // compact_alpha_min,                                                             <L 947>
                var_117 = {};
                var_118 = {};
                var_119 = {};
                var_120 = {};
                ...
                var_128 = {};
                var_129 = {};
                var_130 = wp::float32(1);
                adj_alpha_at_pixel_0(var_45, var_48, var_51, var_54, var_16, var_9, var_14, var_115, var_116, var_focal, var_compact_enabled, var_compact_beta, var_compact_alpha_min, var_117, var_118, var_119, var_120, var_121, var_122, var_123, var_124, var_125, var_126, var_127, var_128, var_129, var_130);
                var_131 = wp::tuple_t<wp::vec_t<3, wp::float32>, wp::vec_t<3, wp::float32>, wp::vec_t<4, wp::float32>, float, wp::mat_t<4, 4, wp::float32>, float, float, float, float, float, int, float, float>(var_117, var_118, var_119, var_120, var_121, var_122, var_123, var_124, var_125, var_126, var_127, var_128, var_129);
                var_133 = wp::extract<0>(var_131);
                var_135 = wp::extract<1>(var_131);
                var_137 = wp::extract<2>(var_131);
                var_139 = wp::extract<3>(var_131);
                var_141 = wp::extract<4>(var_131);
                var_143 = wp::extract<5>(var_131);
                var_145 = wp::extract<6>(var_131);
                var_147 = wp::extract<7>(var_131);
                var_149 = wp::extract<8>(var_131);
                var_151 = wp::extract<9>(var_131);
                var_153 = wp::extract<10>(var_131);
                var_155 = wp::extract<11>(var_131);
                var_157 = wp::extract<12>(var_131);
                // wp.atomic_add(                                                                 <L 950>
                // mean_grad_flat,                                                                <L 951>
                // splat * 3 + 0,                                                                 <L 952>
                var_159 = wp::mul(var_43, var_158);
                var_161 = wp::add(var_159, var_160);
                // alpha_adjoint * mean_alpha_grad[0],                                            <L 953>
                var_163 = wp::extract(var_133, var_162);
                var_164 = wp::mul(var_114, var_163);
                var_165 = wp::atomic_add(var_mean_grad_flat, var_161, var_164);
                // wp.atomic_add(                                                                 <L 955>
                // mean_grad_flat,                                                                <L 956>
                // splat * 3 + 1,                                                                 <L 957>
                var_167 = wp::mul(var_43, var_166);
                var_169 = wp::add(var_167, var_168);
                // alpha_adjoint * mean_alpha_grad[1],                                            <L 958>
                var_171 = wp::extract(var_133, var_170);
                var_172 = wp::mul(var_114, var_171);
                var_173 = wp::atomic_add(var_mean_grad_flat, var_169, var_172);
                // wp.atomic_add(                                                                 <L 960>
                // mean_grad_flat,                                                                <L 961>
                // splat * 3 + 2,                                                                 <L 962>
                var_175 = wp::mul(var_43, var_174);
                var_177 = wp::add(var_175, var_176);
                // alpha_adjoint * mean_alpha_grad[2],                                            <L 963>
                var_179 = wp::extract(var_133, var_178);
                var_180 = wp::mul(var_114, var_179);
                var_181 = wp::atomic_add(var_mean_grad_flat, var_177, var_180);
                // wp.atomic_add(                                                                 <L 966>
                // scale_grad_flat,                                                               <L 967>
                // splat * 3 + 0,                                                                 <L 968>
                var_183 = wp::mul(var_43, var_182);
                var_185 = wp::add(var_183, var_184);
                // alpha_adjoint * log_scale_alpha_grad[0],                                       <L 969>
                var_187 = wp::extract(var_135, var_186);
                var_188 = wp::mul(var_114, var_187);
                var_189 = wp::atomic_add(var_scale_grad_flat, var_185, var_188);
                // wp.atomic_add(                                                                 <L 971>
                // scale_grad_flat,                                                               <L 972>
                // splat * 3 + 1,                                                                 <L 973>
                var_191 = wp::mul(var_43, var_190);
                var_193 = wp::add(var_191, var_192);
                // alpha_adjoint * log_scale_alpha_grad[1],                                       <L 974>
                var_195 = wp::extract(var_135, var_194);
                var_196 = wp::mul(var_114, var_195);
                var_197 = wp::atomic_add(var_scale_grad_flat, var_193, var_196);
                // wp.atomic_add(                                                                 <L 976>
                // scale_grad_flat,                                                               <L 977>
                // splat * 3 + 2,                                                                 <L 978>
                var_199 = wp::mul(var_43, var_198);
                var_201 = wp::add(var_199, var_200);
                // alpha_adjoint * log_scale_alpha_grad[2],                                       <L 979>
                var_203 = wp::extract(var_135, var_202);
                var_204 = wp::mul(var_114, var_203);
                var_205 = wp::atomic_add(var_scale_grad_flat, var_201, var_204);
                // wp.atomic_add(                                                                 <L 982>
                // quaternion_grad_flat,                                                          <L 983>
                // splat * 4 + 0,                                                                 <L 984>
                var_207 = wp::mul(var_43, var_206);
                var_209 = wp::add(var_207, var_208);
                // alpha_adjoint * quaternion_alpha_grad[0],                                      <L 985>
                var_211 = wp::extract(var_137, var_210);
                var_212 = wp::mul(var_114, var_211);
                var_213 = wp::atomic_add(var_quaternion_grad_flat, var_209, var_212);
                // wp.atomic_add(                                                                 <L 987>
                // quaternion_grad_flat,                                                          <L 988>
                // splat * 4 + 1,                                                                 <L 989>
                var_215 = wp::mul(var_43, var_214);
                var_217 = wp::add(var_215, var_216);
                // alpha_adjoint * quaternion_alpha_grad[1],                                      <L 990>
                var_219 = wp::extract(var_137, var_218);
                var_220 = wp::mul(var_114, var_219);
                var_221 = wp::atomic_add(var_quaternion_grad_flat, var_217, var_220);
                // wp.atomic_add(                                                                 <L 992>
                // quaternion_grad_flat,                                                          <L 993>
                // splat * 4 + 2,                                                                 <L 994>
                var_223 = wp::mul(var_43, var_222);
                var_225 = wp::add(var_223, var_224);
                // alpha_adjoint * quaternion_alpha_grad[2],                                      <L 995>
                var_227 = wp::extract(var_137, var_226);
                var_228 = wp::mul(var_114, var_227);
                var_229 = wp::atomic_add(var_quaternion_grad_flat, var_225, var_228);
                // wp.atomic_add(                                                                 <L 997>
                // quaternion_grad_flat,                                                          <L 998>
                // splat * 4 + 3,                                                                 <L 999>
                var_231 = wp::mul(var_43, var_230);
                var_233 = wp::add(var_231, var_232);
                // alpha_adjoint * quaternion_alpha_grad[3],                                      <L 1000>
                var_235 = wp::extract(var_137, var_234);
                var_236 = wp::mul(var_114, var_235);
                var_237 = wp::atomic_add(var_quaternion_grad_flat, var_233, var_236);
                // wp.atomic_add(                                                                 <L 1003>
                // opacity_grad,                                                                  <L 1004>
                // splat,                                                                         <L 1005>
                // alpha_adjoint * opacity_alpha_grad,                                            <L 1006>
                var_238 = wp::mul(var_114, var_139);
                var_239 = wp::atomic_add(var_opacity_grad, var_43, var_238);
                // wp.atomic_add(                                                                 <L 1009>
                // color_grad_flat,                                                               <L 1010>
                // splat * 3 + 0,                                                                 <L 1011>
                var_241 = wp::mul(var_43, var_240);
                var_243 = wp::add(var_241, var_242);
                // colour_adjoint[0],                                                             <L 1012>
                var_245 = wp::extract(var_75, var_244);
                var_246 = wp::atomic_add(var_color_grad_flat, var_243, var_245);
                // wp.atomic_add(                                                                 <L 1014>
                // color_grad_flat,                                                               <L 1015>
                // splat * 3 + 1,                                                                 <L 1016>
                var_248 = wp::mul(var_43, var_247);
                var_250 = wp::add(var_248, var_249);
                // colour_adjoint[1],                                                             <L 1017>
                var_252 = wp::extract(var_75, var_251);
                var_253 = wp::atomic_add(var_color_grad_flat, var_250, var_252);
                // wp.atomic_add(                                                                 <L 1019>
                // color_grad_flat,                                                               <L 1020>
                // splat * 3 + 2,                                                                 <L 1021>
                var_255 = wp::mul(var_43, var_254);
                var_257 = wp::add(var_255, var_256);
                // colour_adjoint[2],                                                             <L 1022>
                var_259 = wp::extract(var_75, var_258);
                var_260 = wp::atomic_add(var_color_grad_flat, var_257, var_259);
                // prefix_rgb = prefix_rgb + transmittance * alpha * colour                       <L 1025>
                var_261 = wp::mul(var_29, var_58);
                var_262 = wp::mul(var_261, var_62);
                var_263 = wp::add(var_27, var_262);
                // transmittance = next_transmittance                                             <L 1026>
                var_264 = wp::copy(var_66);
            }
            var_265 = wp::where(var_60, var_263, var_27);
            var_266 = wp::where(var_60, var_264, var_29);
            wp::assign(var_27, var_265);
            wp::assign(var_29, var_266);
            goto start_for_0;
        end_for_0:;
    }
}
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_packed)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def pack_vec3_gradient(flat: wp.array(dtype=wp.float32), packed: wp.array(dtype=wp.vec3)):       <L 1030>
        // i = wp.tid()                                                                           <L 1031>
        var_0 = builtin_tid1d();
        // packed[i] = wp.vec3(flat[i * 3], flat[i * 3 + 1], flat[i * 3 + 2])                     <L 1032>
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_packed)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: packed[i] = wp.vec3(flat[i * 3], flat[i * 3 + 1], flat[i * 3 + 2])                <L 1032>
        // adj: i = wp.tid()                                                                      <L 1031>
        // adj: def pack_vec3_gradient(flat: wp.array(dtype=wp.float32), packed: wp.array(dtype=wp.vec3)):  <L 1030>
        continue;
    }
}
    ...
    wp::float32 var_eps)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def adam_quaternion_step(                                                              <L 1036>
        // i = wp.tid()                                                                           <L 1049>
        var_0 = builtin_tid1d();
        // g = wp.vec4(gradients[i * 4], gradients[i * 4 + 1], gradients[i * 4 + 2], gradients[i * 4 + 3])       <L 1050>
        var_2 = wp::mul(var_0, var_1);
        ...
        // m[i] = beta1 * m[i] + (1.0 - beta1) * g                                                <L 1051>
        ...
        // v[i] = beta2 * v[i] + (1.0 - beta2) * wp.cw_mul(g, g)                                  <L 1052>
        ...
        // mhat = m[i] / (1.0 - wp.pow(beta1, t + 1.0))                                           <L 1053>
        ...
        // vhat = v[i] / (1.0 - wp.pow(beta2, t + 1.0))                                           <L 1054>
        ...
        // sqrt_vhat = wp.vec4(wp.sqrt(vhat[0]), wp.sqrt(vhat[1]), wp.sqrt(vhat[2]), wp.sqrt(vhat[3]))       <L 1055>
        ...
        // eps_vec4 = wp.vec4(eps, eps, eps, eps)                                                 <L 1056>
        var_68 = wp::vec_t<4, wp::float32>(var_eps, var_eps, var_eps, var_eps);
        // q = quaternions[i] - lr * wp.cw_div(mhat, (sqrt_vhat + eps_vec4))                      <L 1057>
        ...
        // quaternions[i] = q / wp.sqrt(wp.dot(q, q) + 1.0e-8)                                    <L 1058>
    ...
    wp::float32 adj_eps)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: quaternions[i] = q / wp.sqrt(wp.dot(q, q) + 1.0e-8)                               <L 1058>
        ...
        // adj: q = quaternions[i] - lr * wp.cw_div(mhat, (sqrt_vhat + eps_vec4))                 <L 1057>
        wp::adj_vec_t(var_eps, var_eps, var_eps, var_eps, adj_eps, adj_eps, adj_eps, adj_eps, adj_68);
        // adj: eps_vec4 = wp.vec4(eps, eps, eps, eps)                                            <L 1056>
        ...
        // adj: sqrt_vhat = wp.vec4(wp.sqrt(vhat[0]), wp.sqrt(vhat[1]), wp.sqrt(vhat[2]), wp.sqrt(vhat[3]))  <L 1055>
        ...
        // adj: vhat = v[i] / (1.0 - wp.pow(beta2, t + 1.0))                                      <L 1054>
        ...
        // adj: mhat = m[i] / (1.0 - wp.pow(beta1, t + 1.0))                                      <L 1053>
        ...
        // adj: v[i] = beta2 * v[i] + (1.0 - beta2) * wp.cw_mul(g, g)                             <L 1052>
        ...
        // adj: m[i] = beta1 * m[i] + (1.0 - beta1) * g                                           <L 1051>
        ...
        wp::adj_mul(var_0, var_1, adj_0, adj_1, adj_2);
        // adj: g = wp.vec4(gradients[i * 4], gradients[i * 4 + 1], gradients[i * 4 + 2], gradients[i * 4 + 3])  <L 1050>
        // adj: i = wp.tid()                                                                      <L 1049>
        // adj: def adam_quaternion_step(                                                         <L 1036>
        continue;
    }
}
