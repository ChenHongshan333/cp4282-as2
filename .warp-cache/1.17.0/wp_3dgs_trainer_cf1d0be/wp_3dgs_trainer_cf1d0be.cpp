...
struct wp_args_render_backward_2c27b4c8 {
    wp::array_t<wp::vec_t<3, wp::float32>> means;
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> opacity_logits;
...
void render_backward_2c27b4c8_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_backward_2c27b4c8 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
...
// Python CPU entry points
WP_API void render_backward_2c27b4c8_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_backward_2c27b4c8 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_backward_2c27b4c8_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
struct wp_args_render_forward_63084a97 {
    wp::array_t<wp::vec_t<3, wp::float32>> means;
    wp::array_t<wp::vec_t<3, wp::float32>> log_scales;
    wp::array_t<wp::vec_t<4, wp::float32>> quaternions;
    wp::array_t<wp::float32> opacity_logits;
...
void render_forward_63084a97_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_forward_63084a97 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
...
void render_forward_63084a97_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_render_forward_63084a97 *_wp_args,
    wp_args_render_forward_63084a97 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_means = _wp_args->means;
...
// Python CPU entry points
WP_API void render_forward_63084a97_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_forward_63084a97 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_forward_63084a97_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void render_forward_63084a97_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_render_forward_63084a97 *_wp_args,
    wp_args_render_forward_63084a97 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        render_forward_63084a97_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
...
struct wp_args_mse_pixel_gradient_f38ca9fa {
    wp::array_t<wp::vec_t<3, wp::float32>> image;
...
void mse_pixel_gradient_f38ca9fa_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
...
void mse_pixel_gradient_f38ca9fa_cpu_kernel_backward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_args,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_image = _wp_args->image;
...
// Python CPU entry points
WP_API void mse_pixel_gradient_f38ca9fa_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mse_pixel_gradient_f38ca9fa_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void mse_pixel_gradient_f38ca9fa_cpu_backward(
    wp::launch_bounds_t<1> *dim,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_args,
    wp_args_mse_pixel_gradient_f38ca9fa *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mse_pixel_gradient_f38ca9fa_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
